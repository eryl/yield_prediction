...
T = TypeVar('T')
def get_module_obj(module_path: Path, object_type: Type[T], default: Optional[Type[T]]=None) -> T:
    """
    Given a path to a python module, load it as a module and return the first matching object of type *object_type*
    ...
    if default is not None:
        ...
        raise ValueError(f"File {module_path} does not contain any root level objects of type {object_type}")
